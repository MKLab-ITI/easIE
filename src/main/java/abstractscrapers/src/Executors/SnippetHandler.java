...
/**
 * SnippetHandler transforms the scraped data into Snippet Objects and stores them into 
...
public class SnippetHandler {
    ...
    * @param company_fields: scraped company fields
    * @param snippet_fields: scraped snippet fields
    * @throws Exception 
    */
   ...
   /**
    * Stores scraped data (companies_fields and snippet_fields) into mongodb or drive
    * @param storeInfo contains information about where the data are going to be stored
    * @param sourceName the scraped source name
   ...
   /**
    * @returns the scraped data into JSON format 
    */
