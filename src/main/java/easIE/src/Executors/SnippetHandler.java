...
/**
 * SnippetHandler transforms the extracted data into Snippet Objects and stores
...
public class SnippetHandler {
    ...
    /**
     * Stores the extracted data (companies_fields and snippet_fields) into
     * mongodb or drive
     *
     * @param storeInfo contains information about where the data are going to
     * be stored
            ...
            for (int i = 0; i < company_fields.size(); i++) {
                if (storeInfo.toMongo != null && storeInfo.as.equals(SnippetType.COMPANY_SNIPPET) && storeInfo.toHardDrive == null) {
                    ...
                    if (companyInfo.get("Company Name") != null) {
                        ...
                        if (companyInfo.containsKey("Website") && !companyInfo.get("Website").equals("-")) {
                    ...
                    if (i == company_fields.size() - 1) {
                        ...
                        JSONArray prettyJSON = new JSONArray(abstractJSON);
                        writer.println(prettyJSON.toString(4));
                        writer.close();
                    } else {
                        abstractJSON += snippet.getSnippetDBObject() + ",";
                    }
