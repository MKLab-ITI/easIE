 ...
 * @author vasgat
 */
public class Newsweek2014Wrapper {
   private ArrayList<Field> CompaniesInfo;
   private ArrayList<Field> CompaniesSnippets;
   public DynamicHTMLWrapper wrapper;
   
   public Newsweek2014Wrapper() throws URISyntaxException, IOException, InterruptedException{
   ...
   private void getCompaniesSnippets() throws UnknownHostException{
      ArrayList<HashMap<String, Object>> info = wrapper.extractTable(
              "table.ranking-table:nth-child(3) > tbody:nth-child(3) > tr", 
              CompaniesInfo
      );
      ...
      for (int i=0; i<info.size(); i++){
         ...
         if(temp_Comp.get("Company Name")!=null&&!temp_Comp.equals("")){
   ...
   public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException{
      Newsweek2014Wrapper newsweek = new Newsweek2014Wrapper();
