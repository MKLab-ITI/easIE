...
public class CosineSimilarity {
    ...
    /**
     * Calculates the cosine similarity between two docs, givem the collection
     * of documents
     *
     * @param weights
     * @param doc1_id
    ...
    public static double calculate(String name1, String name2) {
        if (name1 != null && name2 != null) {
            HashMap<String, Double> doc1 = Tokenizer.getTokenVectorFrequency2(name1);
            HashMap<String, Double> doc2 = Tokenizer.getTokenVectorFrequency2(name2);
            Set<String> terms = new TreeSet<String>();
            terms.addAll(doc1.keySet());
            terms.addAll(doc2.keySet());
            Iterator it = terms.iterator();
            ...
            return sum1 / (Math.sqrt(sum2) * Math.sqrt(sum3));
        } else if ((name1 == null && name2 != null) || (name1 != null && name2 == null)) {
            return 0.0;
        } else {
            return 1.0;
        }
